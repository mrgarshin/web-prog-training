  ...
  <body class="p-3">
    <div class="row">
      <div class="col-6 position-static">
        <h2>Продукты</h2>
        <div class="fruits">
          <img src="https://pngicon.ru/file/uploads/banan-128x128.png" alt="" class="banana fruit" cost="100">
          <img src="https://icons.veryicon.com/png/Food%20%26%20Drinks/Food%202/grapes.png" alt="" cost="150" class="fruit">
          <img src="https://cdn.iconscout.com/icon/free/png-256/red-apple-fruit-emoj-symbol-food-30677.png" alt="" cost="75" class="fruit">
        </div>
      </div>
      <div class="col-6 position-static">
        <h2>Корзина</h2>
